...
| <a href="http://www.martinhinz.info">www.martinhinz.info</a>
</div>
...
- Übergang vom Neolithikum/Kupferzeit zur Bronzezeit; Megalithen; ^14^C Daten; Demographische Analysen; Agentenbasierte Simulationen; Predictive Modelling/Mapping; Räumliche Statistik/Simulationen; Softwareentwicklung für archäologische Anwendungen
...
- Einreichung der Dissertation zur Erlangung des Grades eines Doktors der Philosophie an der CAU Kiel
...
- Bad Oldesloe/Wolkenwehe LA 154 (Neolithische Feuchtbodensiedlung)

`2014–2016`

- Oldenburg/Wangels LA 69 (megalithisches Ganggrab)
...
- IT-Grundlagen
  - Datensicherheit; Content-Managment; Hardware

- Systeme
  - Windows; Unix/Linux; MacOS

- Standard-Anwendungen
  - Office-Software: Microsoft Office, OpenOffice; Graphiksoftware: Adobe Photoshop, Gimp; DTP-Software: Adobe InDesign, Scribus, QuarkXpress

- Archäologie-spezifische Anwendungen
  - GIS: Grass, QGIS, ArcMap, MapInfo, SAGA; Statistik-Software: R, SPSS, (Win-)BASP; 3D-Szenenrekonstruktion, Structure from Motion; 14C-Kalibrationsprogramme; Stratigraphieprogramme

- Programmiersprachen
  - PHP; Java; C & C++; HTML; JavaScript; Active Server Pages; Ruby (on Rails); XML

- Datenbanken
  - Microsoft Access; MySQL; PostgreSQL; SQlite

- Systementwicklung
  - Datenbankdesign; Netzwerktechnik; Strukturierte Analyse
...
- Lesenswert – Leittexte der Ur- und Frühgeschichte, CAU Kiel  
- Johanna-Mestorf Academy R-Courses, CAU Kiel

`2016`

- Lehrgrabung Wangels: Ausgrabung eines Megalithgrabes, CAU Kiel

`2015`

- Lehrgrabung Wangels: Ausgrabung eines Megalithgrabes, CAU Kiel  
- Lesenswert II, Grundtexte der archäologischen Nachbardisziplinen, CAU Kiel

`2014`

- Grundlegende statistische Verfahren für archäologische Datenanalyse in R, CAU Kiel  
- Keramikaufnahme und -auswertung, CAU Kiel  
- Darstellung und Vorstellung: Visualisierung in der Archäologie, CAU Kiel  
- Lesenswert? - Leittexte der Ur- und Frühgeschichte, CAU Kiel  
- Aufnahme und statistische Auswertung archäologischer Daten, Uni Bern  

`2013`

- Archäologische Nachhersage. Prädiktive Modelle für Forschung und Denkmalpflege, CAU Kiel  
- Von der Agrarwirtschaft zum Metallhandwerker: Modelle in der Archäologie, CAU Kiel  
